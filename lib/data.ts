...
export const experience = [
  {
    ...
    company: 'Kipplo Technologies Pvt. Ltd.',
    location: 'Bengaluru',
  ...
  },
  {
    id: 2,
    title: 'AI Workflow Engineer',
    company: 'DemandNXT Business Services Pvt. Ltd.',
    location: 'Bengaluru',
    period: 'March 2026 – June 2026',
    type: 'Full-Time',
    description: 'Built and optimized AI workflow automation pipelines, batch processing systems, and API integrations for automated business processes.',
    responsibilities: ['AI Workflows', 'Automation Pipelines', 'API Integration', 'Batch Processing'],
  },
  {
    id: 3,
...
export const skills = {
  ...
  ai_ml: ['Machine Learning', 'NLP', 'GenAI', 'Prompt Engineering'],
  tools: ['Git', 'GitHub', 'VS Code', 'Anaconda', 'AWS', 'GCP'],
  soft: ['Leadership', 'Problem Solving', 'Communication', 'Teamwork'],
};

export const certifications = [
  { title: 'Introduction to Machine Learning', issuer: 'Duke University', date: '2024' },
  { title: 'Introduction to DevOps', issuer: 'IBM', date: '2024' },
];
